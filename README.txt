...
NPAGE [text]  Sets the default text needed to trigger the (pseudo)code for a new page, without one necessarily have been reached naturally.
              Default: ;;;

NLINE [text]  Sets the default text needed to trigger the (pseudo)code for a new line, without one necessarily have been reached naturally.
              Default: ,,,
